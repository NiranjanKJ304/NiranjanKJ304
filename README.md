...
<img src="https://img.shields.io/badge/MCP-0E7490?style=for-the-badge&logo=anthropic&logoColor=white"/>
...
I'm an **AI Engineer** working on production-grade AI applications with a focus on:
...
I'm working on production AI features for [FirstSolve](https://firstsolve.net/), including:

* 🎫 Intelligent ticket understanding
* 🧠 Context analysis
* 🔎 Knowledge retrieval
* 💡 Contextual solution suggestions
* ✍️ AI-powered response enhancement
...
<img src="https://img.shields.io/badge/RAG-111827?style=for-the-badge&logo=googlegemini&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Qdrant-111827?style=for-the-badge&logo=qdrant&logoColor=DC244C"/>
<img src="https://img.shields.io/badge/Semantic_Search-111827?style=for-the-badge&logo=google&logoColor=white"/>
<img src="https://img.shields.io/badge/Vector_Database-111827?style=for-the-badge&logo=databricks&logoColor=white"/>
...
**100K+ Candidate Profiles → AI Ranking → Top Candidates**

An offline AI candidate-ranking engine combining:

`Feature Engineering` → `Semantic Matching` → `Retrieval` → `Multi-Stage Ranking`
...
An AI-powered crime investigation and analytics platform combining:

`ETL` → `PostgreSQL` → `Knowledge Graph` → `Vector Search` → `GraphRAG` → `LLM Reasoning`

🔗 [View Project](https://github.com/NiranjanKJ304/crime-intelligence-bot)

---

### 💰 AI MSME Loan Processor

An AI-driven lending workflow designed to evaluate MSME financial health using alternative financial data and intelligent decision workflows.

🔗 [View Project](https://github.com/NiranjanKJ304/AI-MSME-Loanprocess)

---

### 🎤 AI Interview BOT

An AI-powered conversational interview platform combining:

`LLM` + `Speech Recognition` + `Interview Context` + `Response Analysis` + `Automated Assessment`
...
<img height="180" src="https://github-readme-stats.vercel.app/api?username=NiranjanKJ304&show_icons=true&theme=github_dark&hide_border=true&include_all_commits=true&count_private=true&rank_icon=github"/>

<img height="180" src="https://github-readme-stats.vercel.app/api/top-langs/?username=NiranjanKJ304&layout=compact&theme=github_dark&hide_border=true&langs_count=8"/>
